...
export default function Suggestions(props) {
  ...
  useEffect(refreshSuggestions, [site, totalNum, onlyMine, accepted, denied, waiting, changed, handleScroll, props.userId]);
...
export class Suggest extends React.Component {
  ...
  suggestCall() {
    suggest({ userId: this.props.userId, ytid: this.state.ytid }, this.cb);
